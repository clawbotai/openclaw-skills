...
Learn how to use the **customer-support** skill effectively.

---

## What You'll Learn

- How customer-support integrates with OpenClaw
...
ls skills/customer-support/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/customer-support/SKILL.md
```
