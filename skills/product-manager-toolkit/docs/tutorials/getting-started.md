...
ls skills/product-manager-toolkit/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/product-manager-toolkit/SKILL.md
```
...
```bash
python3 skills/product-manager-toolkit/scripts/customer_interview_analyzer.py --help\n```\n\nExplore available commands and options.\n
## Step 4: Run rice_prioritizer.py

```bash
python3 skills/product-manager-toolkit/scripts/rice_prioritizer.py --help\n```\n\nExplore available commands and options.\n
## Next Steps
