# Getting Started with web-bundling

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **web-bundling** skill effectively.

---

## What You'll Learn

- How web-bundling integrates with OpenClaw
...
ls skills/web-bundling/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/web-bundling/SKILL.md
```
