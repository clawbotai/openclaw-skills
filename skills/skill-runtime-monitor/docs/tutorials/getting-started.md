...
ls skills/skill-runtime-monitor/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/skill-runtime-monitor/SKILL.md
```
...
```bash
python3 skills/skill-runtime-monitor/scripts/monitor.py --help\n```\n\nExplore available commands and options.\n
## Step 4: Run schemas.py

```bash
python3 skills/skill-runtime-monitor/scripts/schemas.py --help\n```\n\nExplore available commands and options.\n
## Step 5: Run usage_example.py

```bash
python3 skills/skill-runtime-monitor/scripts/usage_example.py --help\n```\n\nExplore available commands and options.\n
## Next Steps
