...
Learn how to use the **auth** skill effectively.

---

## What You'll Learn

- How auth integrates with OpenClaw
...
ls skills/auth-patterns-patterns/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/auth-patterns-patterns/SKILL.md
```
