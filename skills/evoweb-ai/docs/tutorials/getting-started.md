# Getting Started with evoweb-ai

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **evoweb-ai** skill effectively.

---

## What You'll Learn

- How evoweb-ai integrates with OpenClaw
...
ls skills/evoweb-ai/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/evoweb-ai/SKILL.md
```
