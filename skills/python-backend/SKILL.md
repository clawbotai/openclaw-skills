...
### Connected Skills
- **security** → auth patterns, input validation, secrets management baked into scaffolds
- **observability** → structured logging, tracing, health endpoints generated by default
- **devops** → Dockerfile, CI/CD pipeline, deployment config generated alongside code
- **docs-engine** → API documentation scaffold (OpenAPI)
