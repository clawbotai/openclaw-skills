# Getting Started with sw-python-backend

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **sw-python-backend** skill effectively.

---

## What You'll Learn

- How sw-python-backend integrates with OpenClaw
...
ls skills/python-backend/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/python-backend/SKILL.md
```
