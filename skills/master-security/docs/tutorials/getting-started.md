# Getting Started with master-security

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-security** skill effectively.

---

## What You'll Learn

- How master-security integrates with OpenClaw
...
ls skills/master-security/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/master-security/SKILL.md
```
