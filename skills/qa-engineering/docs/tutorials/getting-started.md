# Getting Started with master-qa

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-qa** skill effectively.

---

## What You'll Learn

- How master-qa integrates with OpenClaw
...
ls skills/qa-engineering/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/qa-engineering/SKILL.md
```
