# Getting Started with master-observability

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-observability** skill effectively.

---

## What You'll Learn

- How master-observability integrates with OpenClaw
...
ls skills/observability/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/observability/SKILL.md
```
