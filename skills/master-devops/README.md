...
> Complete DevOps toolkit — CI/CD pipelines, infrastructure as code, containers, Kubernetes, GitOps, security, monitoring, progressive delivery, and pipeline monitoring across GitHub/GitLab.
...
```bash
ls skills/master-devops/SKILL.md
```
...
```bash
cat skills/master-devops/SKILL.md
```
## Key Features
