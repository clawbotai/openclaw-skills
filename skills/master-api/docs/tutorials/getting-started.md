# Getting Started with master-api

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-api** skill effectively.

---

## What You'll Learn

- How master-api integrates with OpenClaw
...
ls skills/master-api/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/master-api/SKILL.md
```
