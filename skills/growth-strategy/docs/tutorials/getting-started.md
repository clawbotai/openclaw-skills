# Getting Started with master-growth

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-growth** skill effectively.

---

## What You'll Learn

- How master-growth integrates with OpenClaw
...
ls skills/growth-strategy/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/growth-strategy/SKILL.md
```
