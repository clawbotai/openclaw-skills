# Getting Started with skill-evolutionary-loop

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **skill-evolutionary-loop** skill effectively.

---

## What You'll Learn

- How skill-evolutionary-loop integrates with OpenClaw
...
ls skills/skill-evolutionary-loop/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/skill-evolutionary-loop/SKILL.md
```

Understand the triggers, workflow steps, and safety considerations.

## Step 3: Run loop_manager.py

```bash
python3 skills/skill-evolutionary-loop/scripts/loop_manager.py --help\n```\n\nExplore available commands and options.\n
## Next Steps
