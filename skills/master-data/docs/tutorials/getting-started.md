...
Learn how to use the **master-data** skill effectively.

---

## What You'll Learn

- How master-data integrates with OpenClaw
...
ls skills/master-data/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/master-data/SKILL.md
```
