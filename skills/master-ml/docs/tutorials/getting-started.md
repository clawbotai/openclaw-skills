# Getting Started with master-ml

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-ml** skill effectively.

---

## What You'll Learn

- How master-ml integrates with OpenClaw
...
ls skills/master-ml/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/master-ml/SKILL.md
```
