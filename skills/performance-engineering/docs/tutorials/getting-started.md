# Getting Started with master-performance

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-performance** skill effectively.

---

## What You'll Learn

- How master-performance integrates with OpenClaw
...
ls skills/performance-engineering/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/performance-engineering/SKILL.md
```
