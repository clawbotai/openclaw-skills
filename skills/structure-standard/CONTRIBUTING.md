# Contributing to structure-standard
...
2. **Clone** your fork locally:
   ...
   cd openclaw-skills/skills/structure-standard
   ```
3. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/clawbotai/openclaw-skills.git
   ```
...
bash scripts/validate-structure.sh . skill  # verify your changes
# npm install / pip install -e ".[dev]" / go mod download

# Verify your setup
bash scripts/validate-structure.sh . skill
