# Getting Started with clawrag

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **clawrag** skill effectively.

---

## What You'll Learn

- How clawrag integrates with OpenClaw
...
ls skills/clawrag/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/clawrag/SKILL.md
```
