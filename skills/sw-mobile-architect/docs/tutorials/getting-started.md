# Getting Started with sw-mobile-architect

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **sw-mobile-architect** skill effectively.

---

## What You'll Learn

- How sw-mobile-architect integrates with OpenClaw
...
ls skills/sw-mobile-architect/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/sw-mobile-architect/SKILL.md
```
