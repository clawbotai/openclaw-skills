# Getting Started with sveltekit-webapp

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **sveltekit-webapp** skill effectively.

---

## What You'll Learn

- How sveltekit-webapp integrates with OpenClaw
...
ls skills/sveltekit-webapp/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/sveltekit-webapp/SKILL.md
```
