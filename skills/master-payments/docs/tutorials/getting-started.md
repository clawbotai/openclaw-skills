# Getting Started with master-payments

> **Type:** Tutorial | **Time:** ~15 minutes | **Prerequisites:** OpenClaw running

Learn how to use the **master-payments** skill effectively.

---

## What You'll Learn

- How master-payments integrates with OpenClaw
...
ls skills/master-payments/SKILL.md
```

## Step 2: Read the Skill Definition

```bash
cat skills/master-payments/SKILL.md
```
